...
def build_nlp_options(options, help_options, user_options, options_tree, architecture):
    ...
    options_tree.append(('nlp', 'cost', 'normalization', 'beta',                 n_k*N_k,             ('beta regularisation cost normalization', None),'x'))
    options_tree.append(('nlp', 'cost', 'normalization', 'invariants',           n_k*N_k,             ('invariants regularisation cost normalization', None),'x'))
